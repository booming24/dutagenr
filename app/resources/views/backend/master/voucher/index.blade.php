    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <!-- Formulir di sini -->
                <form action="{{ route('create_voucher') }}" enctype="multipart/form-data" method="post">
                    @csrf
        ...
        <tbody>
            ...
            <tr>
                ...
                <td> <a href="" class="btn btn-sm btn-success"><svg xmlns="http://www.w3.org/2000/svg" width="16" style="margin-top: -0px;" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
                    ...
                    <a href="{{ route('delete_voucher', $item->id) }}" onclick="return confirm('Yakin hapus data ini?')" class="btn btn-sm btn-danger"><i class="bi bi-trash-fill"></i></a>
                </td>
            </tr>
            @endforeach
        </tbody>
