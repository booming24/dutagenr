...
<div id="peserta">
    <div class="text-center">
        ...
        <div class="row mb-4">
            <div class="col">
                <a href="/voting" class="btn btn-outline-primary" style="border-radius: 16px;border: 2px solid;width: 200px;height:42px;cursor: pointer;font-family: Poppins; font-weight: 700; margin-top: 30px;">Statistik
                    Vote</a>
                <a type="button" data-bs-toggle="modal" data-bs-target="#modalll" class="btn btn-outline-primary" style="border-radius: 16px;border: 2px solid;width: 200px;height:42px;cursor: pointer;font-family: Poppins; font-weight: 700; margin-top: 30px;">Beli
                    Voucher</a>
            </div>
            <!-- Modal -->
        ...
        <div class="col-lg-12">
            <div class="row d-flex justify-content-beetwen">
                ...
                <div class="col-lg-4 d-flex flex-column align-items-center pb-5">
                    <div class="card" style="box-shadow: 3px 0px 6px 0px #00000040;
                             width: 20rem;">
                        <div style="padding: 10%">
                            <img src="/peserta/{{ $item->foto }}" style="box-shadow: 0px 4px 4px 0px rgba(0, 0, 0, 0.25);
                        ...
                        <div class="card-body d-flex flex-column align-items-center">
                            ...
                            <button type="button" class="btn btn-primary" id="vote-popup" data-no-peserta="{{ $item->no_peserta }}" data-nama-peserta="{{ $item->nama_peserta }}" data-id-peserta="{{ $item->id }}" data-foto-peserta="{{ $item->foto }}" data-bs-toggle="modal" data-bs-target="#myModal1">
                                VOTE
                            </button>
                        </div>
                    </div>
    ...
    <div class="kotak">
        ...
        <div class="gabung">
            <button type="button" class="buyy-button mt-1" data-bs-toggle="modal" data-bs-target="#modalll" style="margin-left: 0px;">
                Beli Sekarang
            </button>
            <!-- Modal -->
