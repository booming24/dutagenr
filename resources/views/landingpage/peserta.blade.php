        ...
        <div class="row mb-4">
            <div class="col">
                <a href="/voting" class="btn btn-outline-primary"
                    ...
                    Vote</a>
                <a type="button" data-bs-toggle="modal" data-bs-target="#modal1" class="btn btn-outline-primary"
                ...
                <div class="card" style="box-shadow: 3px 0px 6px 0px #00000040;
                    ...
                    <div class="card-body d-flex flex-column align-items-center">
                        ...
                        <button type="button" class="btn btn-primary" id="vote-popup"
                            data-no-peserta="{{ $item->no_peserta }}" data-nama-peserta="{{ $item->nama_peserta }}"
                            data-id-peserta="{{ $item->id }}" data-foto-peserta="{{ $item->foto }}"
