        ...
        <div class="container">
            <div class="latarbelakang">
                <div class="d-flex justify-content-center">
                    <img src="images/tentangbanner.webp" alt="21" />
                </div>
                <b>Latar Belakang</b>
            ...
            <div class="filosofi">
                ...
                <div class="card">
                    <div class="row">
                        <div class="col-lg-6 gambar">
                            <div class="bkkbn">
                                <img src="images/BKKBN.webp" alt="21" class="logo" />
                            </div>
                            <div class="gabung">
                                <img src="images/BKKBN1.webp" alt="21" class="logo" />
                                <img src="images/BKKBN2.webp" alt="21" class="logo" />
                            </div>
                ...
                <div class="card mt-5">
                    <div class="row">
                        <div class="col-lg-6 gambar">
                            <div class="genre">
                                <img src="images/forum.webp" alt="21" class="logo" />
                            </div>
                        </div>
                        <div class="col-lg-5 penjelasan">
                            ...
                            <ol>
                                ...
                                <li><strong>Pita Bermotif Songket</strong>
                                    <p>Menurut tradisi kebudayaan Indonesia, kain songket nan keemasan dikaitkan dengan
                                        kegemilangan Kerajaan Sriwijaya. Harapan kedepannya Forum GenRe Sumatra Selatan
                                        dapat
                                        meraih kesuksesan dan kejayaan dalam menyampaikan informasi dan penyedia wadah
                                        aktifitas
                                        bagi remaja khususnya yang ada di Sumatra Selatan</p>
                                </li>
                            ...
                            <ol>
                                ...
                                <li>
                                    ...
                                    <p>Merupakan carminan dari Sumatera Selatan yang merupakan bunga tertua yang sudah
                                        ...
                                        sebagai
                                        kerajaan maritim terhebat di dunia kala itu. Ikatan Duta GenRe diharapkan dapat
                                        berjaya
                                        seperti kerajaan Sriwijaya pada masa keemasannya.</p>
                                </li>
                                <li>
                                    <strong>Helai Bunga Seruni yang Berjumlah 14 Buah dan Siluet Putra Putri</strong>
                                    <p>Melambangkan hari jadi dari Ikatan Duta GenRe Sumatera Selatan yaitu tanggal 14
                                        Febuari.
                                    </p>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <p>Merupakan landasan yang ditujukan kepada seluruh Remaja di Sumatera Selatan untuk
                                        menghindari TRIAD KRR (Say No To Free Sex, Drugs, HIV/AIDS).</p>
                                </li>
                                <li>
                                    <strong>Siluet Putra-Putri yang memegang Panji segi 5 yang berisi Logo GenRe yang
                                        tertancap
